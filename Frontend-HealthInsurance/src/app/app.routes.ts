...
export const routes: Routes = [
    ...
    { path: 'admin/underwriters', loadComponent: () => import('./pages/admin/underwriters/manage-underwriters.component').then(m => m.ManageUnderwritersComponent), canActivate: [adminGuard] },
    ...
    { path: 'admin/assign-underwriter', loadComponent: () => import('./pages/admin/assign-underwriter/assign-underwriter.component').then(m => m.AssignUnderwriterComponent), canActivate: [adminGuard] },
    ...
    { path: 'admin/assign-claims-officer', loadComponent: () => import('./pages/admin/assign-claims-officer/assign-claims-officer.component').then(m => m.AssignClaimsOfficerComponent), canActivate: [adminGuard] },
    ...
    { path: 'underwriter/dashboard', loadComponent: () => import('./pages/underwriter/dashboard/underwriter-dashboard.component').then(m => m.UnderwriterDashboardComponent), canActivate: [underwriterGuard] },
    { path: 'underwriter/plans', loadComponent: () => import('./pages/underwriter/plans/underwriter-plans.component').then(m => m.UnderwriterPlansComponent), canActivate: [underwriterGuard] },
    { path: 'underwriter/pending', loadComponent: () => import('./pages/underwriter/pending/underwriter-pending.component').then(m => m.UnderwriterPendingComponent), canActivate: [underwriterGuard] },
    { path: 'underwriter/send-quote/:policyId', loadComponent: () => import('./pages/underwriter/send-quote/send-quote.component').then(m => m.SendQuoteComponent), canActivate: [underwriterGuard] },
    { path: 'underwriter/send-quote', loadComponent: () => import('./pages/underwriter/send-quote/send-quote.component').then(m => m.SendQuoteComponent), canActivate: [underwriterGuard] },
    { path: 'underwriter/policies', loadComponent: () => import('./pages/underwriter/policies/underwriter-policies.component').then(m => m.UnderwriterPoliciesComponent), canActivate: [underwriterGuard] },
