...
@Component({
  ...
  styleUrl: './manage-plans.component.css',
})
export class ManagePlansComponent implements OnInit {
  ...
  openEdit(plan: InsurancePlan): void {
    this.form = {
      ...
      basePremiumAmount: plan.basePremiumAmount,
      coverageAmount: plan.coverageAmount,
      planDurationMonths: plan.planDurationMonths,
      minAgeLimit: plan.minAgeLimit,
      maxAgeLimit: plan.maxAgeLimit,
      waitingPeriodMonths: plan.waitingPeriodMonths,
      maternityCover: plan.maternityCover,
      preExistingDiseaseCover: plan.preExistingDiseaseCover,
    };
    this.editing = true;
