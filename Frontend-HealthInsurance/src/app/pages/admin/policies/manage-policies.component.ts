...
export class ManagePoliciesComponent implements OnInit {
    ...
    ngOnInit(): void { this.api.getAllPolicies().subscribe({ next: (d) => { this.policies = d; this.loading = false; this.cdr.detectChanges(); }, error: () => { this.loading = false; this.cdr.detectChanges(); } }); }
